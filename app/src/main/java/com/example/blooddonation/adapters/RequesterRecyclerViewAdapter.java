...
public class RequesterRecyclerViewAdapter extends RecyclerView.Adapter<RequesterRecyclerViewAdapter.MyViewHolder> {

    private Context mContext;
    private List<User> mData;
    RequestOptions option;

    public RequesterRecyclerViewAdapter(Context mContext, List<User> mData) {
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                ...
                                                if (document != null) {
                                                    ...
                                                    if (u != null) {
                                                        String msg = "From Blood Donor:\nAs per your request I am " + u.getName() + " ready to donate blood of " + u.getBloodGroup() + " blood group.";

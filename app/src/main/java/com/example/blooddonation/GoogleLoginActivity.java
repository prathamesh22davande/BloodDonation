                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            ...
                                            if(document!=null){
                                                ...
                                                if(u!=null) {
                                                    Toast.makeText(GoogleLoginActivity.this, "Name" + u.getName(), Toast.LENGTH_SHORT).show();
                                                    finish();
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
               ...
               // Log.w(TAG, "Google sign in failed", e);
                // ...
                Toast.makeText(GoogleLoginActivity.this, "Google Sign in failed"+e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           // updateUI(user);
                            ...
                            Toast.makeText(GoogleLoginActivity.this, "Authenticaation Failed", Toast.LENGTH_SHORT).show();
